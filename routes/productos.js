...
// Agregar producto
router.post('/agregarProducto',administradores,cargaImagenes.any(), productosMD , productosController.agregar)

// Vista editar producto
router.get('/editarProducto/:id',administradores, validarSiLogeo ,productosController.vistaEditar)
//Editar producto /productos/editarProducto/:id
router.put('/editarProducto/:id', productosMD ,productosController.editar)

// Eliminar producto
router.delete('/eliminar/:id',administradores, validarSiLogeo ,productosController.eliminar)
